...
export default function Profile() {
  ...
  if (!currentUser) {
    return <div>Loading...</div>; // Or use a spinner or any other loading indicator
  }
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form  onSubmit={handleSubmit}  className='flex flex-col gap-4'>
        ...
        <input type="password" id='password' placeholder='Password ' className='bg-slate-100 rounded-lg p-3' onChange={handleChange}/>
          <button className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:pacity-95 disabled:opacity-80'>{loading ? 'Loading...' : 'Updated'}</button>
      </form>
